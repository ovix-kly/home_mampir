...
public class ModelTempatTerdekatDestinasi {
    ...
    public ModelTempatTerdekatDestinasi(String namaLokasi, String jenisLokasi, String jmlPengunjung, String ratingLokasi){
